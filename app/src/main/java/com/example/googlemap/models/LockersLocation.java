...
public class LockersLocation implements Serializable {
    ...
    protected LockersLocation(Parcel in) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    LatLng markerLatLng = new LatLng(lockersLocation.getLatitude(), lockersLocation.getLongitude());

                    // Calculate the distance between your location and the marker
                    Location markerLocation = new Location("Marker Location");
                    markerLocation.setLatitude(lockersLocation.getLatitude());
                    markerLocation.setLongitude(lockersLocation.getLongitude());
