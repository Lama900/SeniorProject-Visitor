...
import com.example.googlemap.HomeScreen;
import com.example.googlemap.SignInScreen;
import com.example.googlemap.SignUpScreen;
...
public class Vistors {
    ...
    public static void loginUser(String email, String password, SignInScreen context) {
    ...
    public static void registerUser(String email, String password, String fullName, final SignUpScreen activity) {
        FirebaseAuth firebaseAuth = FirebaseAuth.getInstance();
